...
public class Constants
{
    ...
    // urls
    public static final String MC_MANIFEST_URL  = "https://launchermeta.mojang.com/mc/game/version_manifest.json";
    public static final String MC_JAR_URL       = "https://launcher.mojang.com/v1/objects/{CLIENT_HASH}/client.jar";
    public static final String MC_SERVER_URL    = "https://launcher.mojang.com/v1/objects/{SERVER_HASH}/server.jar";
    ...
    public static final String ASSETS_INDEX_URL = "{ASSET_INDEX_URL}";
